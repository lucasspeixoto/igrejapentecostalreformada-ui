        ...
        <nav className="mt-5 p-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/membros/forms' || pathname.includes('forms')
                }>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      <div
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/membros/forms/form-elements"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/membros/forms/form-elements' &&
                                'text-white'
                              }`}>
                              Form Elements
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/membros/forms/form-layout"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/membros/forms/form-layout' &&
                                'text-white'
                              }`}>
                              Form Layout
                            </Link>
