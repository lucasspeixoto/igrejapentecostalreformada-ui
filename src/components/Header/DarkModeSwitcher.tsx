...
import type { ThemeColor } from '@/store/useTheme';
import useTheme from '@/store/useTheme';

const DarkModeSwitcher = () => {
  const theme = useTheme(state => state.themeColor);

  const setTheme = useTheme(state => state.setTheme);

  const setThemeHandle = React.useCallback((themeColor: ThemeColor) => {
    setTheme(themeColor);
  }, []);
    ...
    <li>
      <label
        ...
        <input
          type="checkbox"
          onChange={() => {
            if (typeof setThemeHandle === 'function') {
              setThemeHandle(theme === 'light' ? 'dark' : 'light');
            }
          }}
