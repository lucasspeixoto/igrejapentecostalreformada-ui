...
export const MOCKED_FINANCE_NOTES: FinanceNote[] = [
  {
    ...
    owner: 'Lucas',
    date: Timestamp.fromDate(new Date('2024-03-29T00:00:00')),
    type: 'D',
    value: 150.0,
  },
  {
    ...
    owner: 'Rodrigo',
    date: Timestamp.fromDate(new Date('2024-04-02T00:00:00')),
    type: 'C',
    value: 146.81,
  },
  {
    ...
    description: 'Luz',
    owner: 'Daniel',
    date: Timestamp.fromDate(new Date('2024-04-03T00:00:00')),
    type: 'D',
    value: 621.81,
  },
  {
    ...
    owner: 'Rodrigo',
    date: Timestamp.fromDate(new Date('2024-04-04T00:00:00')),
    type: 'D',
    value: 621.81,
  },
  {
    ...
    owner: 'Lucas',
    date: Timestamp.fromDate(new Date('2024-04-05T00:00:00')),
    type: 'C',
    value: 150.0,
  },
  {
    ...
    owner: 'Rodrigo',
    date: Timestamp.fromDate(new Date('2024-04-07T00:00:00')),
    type: 'C',
    value: 200.0,
  },
  {
