...
import { phoneRegex } from '@/app/plataforma-ipr/cadastro/constants/regex';
...
export type CreatePersonalContactFormData = z.infer<typeof createPersonalContactFormSchema>;
